...
final class MapDemoActivityPermissionsDispatcher {
  ...
  static void getMyLocationWithCheck(MapDemoActivity target) {
  ...
  static void onRequestPermissionsResult(MapDemoActivity target, int requestCode, int[] grantResults) {
    switch (requestCode) {
